                ...
                <div class="ui  segment">
                    <div class="field">
                        <div class="ui left icon input">
                            <i class="user icon"></i>
                            <input id="email_id" type="text" name="email" placeholder="E-mail address"
                                required="required" pattern="^([a-zA-Z0-9]+)@([a-zA-Z]+)\.([a-zA-Z]{2,5})$">
                    ...
                    <div class="field">
                        <div class="ui left icon input">
                            <i class="lock icon"></i>
                            <input id="signin_password_id" type="password" name="password" placeholder="Password"
        ...
        <div class="column">
            ...
            <form class="ui large form" method="POST" action="http://localhost/TheInterio/PHP/signup.php">
                <div class="ui  segment">
                    <div class="field">
                        <div class="ui left icon input">
                            <input id="name_field_id" type="text" name="firstnamefield" value=""
                                placeholder="Enter First Name" required="required" pattern="^[a-zA-z]{3,}$">
                    ...
                    <div class="field">
                        <div class="ui left icon input">
                            <input id="last_name_field_id" type="text" name="lastnamefield" value=""
                                placeholder="Enter Last Name" required="required" pattern="^[a-zA-z]{3,}$">
                    ...
                    <div class="field">
                        <div class="ui left icon input">
                            <i class="user icon"></i>
                            <input id="name_value" type="text" name="usernamefield" placeholder="Username"
                                required="required" pattern="^[a-zA-Z][0-9a-zA-Z]{3,}$">
                    ...
                    <div class="field">
                        <div class="ui left icon input">
                            <i class="user icon"></i>
                            <input id="email_input" type="text" name="emailfield" placeholder="E-mail address"
                                required="required" pattern="^([a-zA-Z0-9]+)@([a-zA-Z]+)\.([a-zA-Z]{2,5})$">
                    ...
                    <div class="field">
                        <div class="ui left icon input">
                            <i class="lock icon"></i>
                            <input id="confirm_password_input" type="password" name="confirm_password"
                                placeholder="Confirm Password" required="required" pattern="^[a-zA-Z0-9]*$">
                            <div>
                    ...
                    <div><button id="signup_btn_id" type="submit"
                            class="ui fluid large primary submit button btn btn-large">Sign up</button>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3">
                    <div class="widget no-box">
                        ...
                        <a class="btn btn-color signup_window_button" id="ft_reg_btn" href="#">Register Now</a>
                    </div>
                </div>
