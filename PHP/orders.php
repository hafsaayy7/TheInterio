                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul id="navbar-div" class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="PHP\orders.php">My orders</a>
                            </li>
                            <li class="nav-item">
                                <a id="additional_service" class="nav-link" href="PHP\service.php">Additional service request</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link login_window_button" href="PHP\support.php">support</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="PHP\home.php">Log out</a>
                            </li>
                        </ul>
                    </div>
                </div>
